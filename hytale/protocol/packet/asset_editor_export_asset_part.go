...
type AssetEditorExportAssetPart struct{}

func (*AssetEditorExportAssetPart) ID() uint32 {
	return IDAssetEditorExportAssetPart
}
...
func (pk *AssetEditorExportAssetPart) Marshal(io protocol.IO) {
	// TODO: Implement
}
