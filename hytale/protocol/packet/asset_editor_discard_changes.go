...
type AssetEditorDiscardChanges struct{}

func (*AssetEditorDiscardChanges) ID() uint32 {
	return IDAssetEditorDiscardChanges
}
...
func (pk *AssetEditorDiscardChanges) Marshal(io protocol.IO) {
	// TODO: Implement
}
