...
type SetMachinimaActorModel struct{}

func (*SetMachinimaActorModel) ID() uint32 {
	return IDSetMachinimaActorModel
}
...
func (pk *SetMachinimaActorModel) Marshal(io protocol.IO) {
	// TODO: Implement
}
