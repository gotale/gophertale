...
type AssetEditorRedoChanges struct{}

func (*AssetEditorRedoChanges) ID() uint32 {
	return IDAssetEditorRedoChanges
}
...
func (pk *AssetEditorRedoChanges) Marshal(io protocol.IO) {
	// TODO: Implement
}
