...
type AssetEditorSelectAsset struct{}

func (*AssetEditorSelectAsset) ID() uint32 {
	return IDAssetEditorSelectAsset
}
...
func (pk *AssetEditorSelectAsset) Marshal(io protocol.IO) {
	// TODO: Implement
}
