...
type AssetEditorRenameAsset struct{}

func (*AssetEditorRenameAsset) ID() uint32 {
	return IDAssetEditorRenameAsset
}
...
func (pk *AssetEditorRenameAsset) Marshal(io protocol.IO) {
	// TODO: Implement
}
